...
class UserItemRatingDataset(Dataset):
    ...
    def __init__(self, user_tensor, item_tensor_s, target_tensor_s, item_tensor_t, target_tensor_t):
        """
        args:
    ...
    def __getitem__(self, index):
            return self.user_tensor[index], self.item_tensor_s[index], self.target_tensor_s[index],self.item_tensor_t[index], self.target_tensor_t[index]
...
class SampleGenerator(object):
    ...
    def _split_loo(self, ratings):
        ...
        return train[['userId', 'itemId', 'rating','rank_latest']], test[['userId', 'itemId', 'rating']]
    ...
    def evaluate_data(self):
        ...
        return [torch.LongTensor(test_users), torch.LongTensor(test_items_s), torch.LongTensor(test_items_t), torch.LongTensor(negative_users),
                torch.LongTensor(negative_items_s), torch.LongTensor(negative_items_t)]
